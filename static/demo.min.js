...
this.combo = new Combo("combo-main-content", "combo-main-echarts"); this.init = function () { this.type.render(); this.combo.render(); return this } }, Statistics = function (a) {
  ...
  this.data = {
            ...
            legend:{data:["QQ",,"微信","迅雷","网易云音乐","爱奇艺"]},
            grid:{left:"3%",right:"4%",bottom:"3%",containLabel:true},
            xAxis:{type:"category",data:time},
            yAxis:{type:"value"},
            animation:false,
            series:[
            {name:"QQ",type:"bar",stack:"QQ",data:qq},
           // {name:"QQ_01",type:"bar",stack:"QQ",data:[10,32,70,73,90,30]},
            {name:"微信",type:"bar",stack:"微信",data:wc},
           // {name:"微信_01",type:"bar",stack:"微信",data:[12,32,11,34,29,23]},
            {name:"爱奇艺",type:"bar",stack:"网易云音乐",data:iqy},
            {name:"迅雷",type:"bar",stack:"迅雷",data:tdr},
           // {name:"迅雷_01",type:"bar",stack:"迅雷",data:[6,7,18,7,19,13]},
            {name:"网易云音乐",type:"bar",stack:"网易云音乐",data:we}]
           // {name:"网易云音乐_01",type:"bar",stack:"网易云音乐",data:[6,8,9,8,10,11]},

           // {name:"爱奇艺_01",type:"bar",stack:"网易云音乐",data:[6,8,9,8,10,11]}]]
            };
    ...
    this.elem = b; this.content = a; this.data = function () {
        ...
        return {
            ...
            legend:{orient:"vertical",left:"left",data:["其他","网易云音乐","迅雷","微信","QQ","爱奇艺"]},
