...
var Demo = function () {
    ...
    this.combo = new Combo("combo-main-content", "combo-main-echarts"); this.init = function () { this.type.render(); this.combo.render(); return this }
    ...
    this.elem = b; this.content = a; this.data = function () {
        ...
        return {
            options: {
                title: { text: "应用程序流量统计", subtext: "饼状图", x: "center" },
...
}, data = [], geoCoordMap = {}, convertData = function (a) { for (var b = [], c = 0; c < a.length; c++) { var d = geoCoordMap[a[c].name]; d && b.push({ name: a[c].name, value: d.concat(a[c].value) }) } return b }, mapData = convertData(data), valueData = convertData(data.sort(function (a, b) { return b.value - a.value })).slice(0, 11); 
